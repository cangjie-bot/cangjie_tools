...
以下为cjbind使用测试命令，需在命令后面手动加入clang路径

```
./main -o /home/danny/Huawei/projects/cangjie_tools_combine/cangjie_tools/cjbind-master/testdata/cjbind_ffi.cj /home/danny/Huawei/projects/cangjie_tools_combine/cangjie_tools/cjbind-master/testdata/test.h --   -I /usr/lib/llvm-14/lib/clang/14.0.0/include   -I /usr/include   -I /usr/include/x86_64-linux-gnu
```
