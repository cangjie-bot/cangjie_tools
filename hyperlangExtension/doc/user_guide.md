...
```sh
hle  -i  /path/to/test.d.ts  -o  out  –j  /path/to/analysis.js --module-name=ohos.hilog
```
...
```sh
hle -b ./src/dtsparser/node_modules/.bin/cjbind -c --module-name="my_module" -d ./tests/c_cases -o ./tests/expected/c_module/ --clang-args="-I/usr/lib/llvm-20/lib/clang/20/include/"
```

The `-b` parameter is used to specify the path to the cjbind binary file. The default value is "./src/dtsparser/node_modules/.bin/cjbind", and the cjbind download link is as follows:

- linux: 'https://gitcode.com/anancds123/cjbind/releases/download/v0.2.9/cjbind-linux-x64'
- win32: 'https://gitcode.com/anancds123/cjbind/releases/download/v0.2.9/cjbind-windows-x64.exe'
- darwin: 'https://gitcode.com/anancds123/cjbind/releases/download/v0.2.9/cjbind-darwin-arm64'
