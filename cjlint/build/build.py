...
LOG_FILE = os.path.join(LOG_DIR, "cjlint.log")
...
def main():
    """build entry"""
    parser = argparse.ArgumentParser(description="build cjlint project")
    subparsers = parser.add_subparsers(help="sub command help")
    parser_build = subparsers.add_parser("build", help="build cjlint")
    ...
    parser_build.add_argument(
        ...
        help='Version string, e.g., 1.1.0-beta.2')
    parser_build.add_argument(
