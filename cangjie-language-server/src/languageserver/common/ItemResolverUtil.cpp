                                            ...
                                            SourceManager *sourceManager)
{
    ...
    if (decl.type && !Ty::IsInitialTy(decl.type->aliasTy)) {
        ...
        auto k1 = decl.type->astKind;
        auto k2 = decl.type->aliasTy->kind;
        // auto kind = decl.type->aliasTy->kind;
        std::cerr << ASTKIND_TO_STR.at(k1) << std::endl;
        // std::cerr << ASTKIND_TO_STR.at(k2) << std::endl;
        // std::cerr << k2.ToString() << std::endl;
