...
private:
    ...
    static void DealMoveFile(const ArkAST *ast, const std::string &file, const std::string &targetPkg, FileRefactor &refactor);

    static void DealRefFile(const ArkAST *ast, const std::string &file, const std::string &targetPkg, FileRefactor &refactor);

    static void DealReExport(const ArkAST *ast, const std::string &targetPkg, const std::string &targetPath, FileRefactor &refactor);
