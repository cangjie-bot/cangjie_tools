                                           ...
                                           const std::string &prefix, CompletionEnv &env)
{
    ...
    inIfAvailible = CheckInIfAvailable(topDecl, pos);
    if (inIfAvailible) {
                                              ...
                                              std::string &scopeName, bool &isInclude)
{
    ...
    } else if (Contain(pIfAvailableExpr->GetLamabda1(), pos)) {
        DeepFind(pIfAvailableExpr->GetLamabda1(), pos, scopeName, isInclude);
    } else if (Contain(pIfAvailableExpr->GetLamabda2(), pos)) {
        DeepFind(pIfAvailableExpr->GetLamabda2(), pos, scopeName, isInclude);
    }
}
