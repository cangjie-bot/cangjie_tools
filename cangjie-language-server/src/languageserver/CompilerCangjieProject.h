...
struct PkgInfo {
public:
    // in common-platform module, this mean common package path
    ...
    // in common-platform module, this set platform package
...
public:
    ...
    std::vector<std::string> GetCommonPlatformModuleSrcPaths(const std::string &modulePath);
