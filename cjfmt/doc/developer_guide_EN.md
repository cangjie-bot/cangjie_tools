...
![cjfmt Architecture Diagram](../figures/cjfmt架构.png)
...
`cjfmt` depends on `cjc` for building. Refer to [SDK Build](https://gitcode.com/Cangjie/cangjie_build/blob/dev/README_zh.md) for build instructions.
